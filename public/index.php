...
$data = [
	...
	'work' => [
		[
			...
			'blurb' => 'Checks a site the way a phone would: page weight, oversized images, whether search engines can read it, whether the copy sounds machine-written. Runs as a web page, a head-to-head comparison, or an MCP server.',
		...
		[
			...
			'blurb' => 'Wired the system of record into their meeting software so daily numbers feed themselves. Found a metric defect inflating the reported figures and reconciled the feed to the official report.',
		...
		[
			...
			'blurb' => 'The vendor had no usable API. Built a scheduled bot that signs in, pulls new applicants and writes them into Salesforce, then fixed the duplicate-record flow behind it.',
		...
		[
			...
			'blurb' => 'A brand knowledge base plus five agents covering email, sales copy, prospect research and campaign collateral. Publish-ready output, so one person covers what took a small team.',
		...
		[
			...
			'blurb' => 'Client sites on Astro, React and WordPress across diesel repair, men\'s health and e-commerce, plus GoHighLevel CRMs wired end to end with lead routing and conversion tracking.',
		...
		[
			...
			'blurb' => 'Built the original site, then came back two years later to rebuild it end to end. Restructured the architecture and shortened the path to booking.',
